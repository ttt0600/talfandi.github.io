const CACHE='arkanat-field-qr-v5-31-20260916';
const CORE=['./index.html','./reprint.js','./shift-attendance.js','./mobile-ux.js','./photo-evidence.js'];
...
async function qrRequest(event,req,url){
  ...
  try{
    ...
    if(looksGuard)return new Response('/* QR library skipped on guard scan */',{status:200,headers:{'content-type':'application/javascript; charset=utf-8','cache-control':'no-store'}});
  }catch(_){}
  return fetch(req);
}
