(()=>{
'use strict';
if(window.__ARK_DIRECT_BOOTSTRAP_V535)return;
window.__ARK_DIRECT_BOOTSTRAP_V535=true;
const V='535';
...
function bootGuard(){
  ...
  load('./shift-attendance.js','directShift535','__ARK_FIELD_SHIFT_ATTENDANCE_V2',false);
  load('./mobile-ux.js','directMobile535','__ARK_FIELD_MOBILE_UX_V4',false);
  later(()=>load('./photo-evidence.js','directPhoto535','__ARK_FIELD_PHOTO_EVIDENCE_V2',false),180);
  later(()=>load('./workflow-ux.js','directWorkflow535','__ARK_FIELD_WORKFLOW_UX_V4',false),320);
  later(()=>load('./photo-evidence-ux.js','directPhotoUx535','__ARK_FIELD_PHOTO_UX_V2',false),700);
}
function boot(){if(activeScan())bootGuard();else load('./reprint-core.js','fieldReprintCore535',null,false);refreshWorkerLater()}
