(()=>{
'use strict';
if(window.__ARK_DIRECT_BOOTSTRAP_V534)return;
window.__ARK_DIRECT_BOOTSTRAP_V534=true;
const V='534';
...
function bootGuard(){
  ...
  load('./shift-attendance.js','directShift534','__ARK_FIELD_SHIFT_ATTENDANCE_V2',false);
  load('./mobile-ux.js','directMobile534','__ARK_FIELD_MOBILE_UX_V4',false);
  later(()=>load('./photo-evidence.js','directPhoto534','__ARK_FIELD_PHOTO_EVIDENCE_V1',false),180);
  later(()=>load('./workflow-ux.js','directWorkflow534','__ARK_FIELD_WORKFLOW_UX_V4',false),320);
  later(()=>load('./photo-evidence-ux.js','directPhotoUx534','__ARK_FIELD_PHOTO_UX_V2',false),700);
}
function boot(){if(activeScan())bootGuard();else load('./reprint-core.js','fieldReprintCore534',null,false);refreshWorkerLater()}
