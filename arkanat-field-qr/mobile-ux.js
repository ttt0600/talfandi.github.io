...
function addStyles(){
  ...
  body.ark-mobile-scan label{margin:8px 0 5px!important;font-size:14px}body.ark-mobile-scan .ark-shift,body.ark-mobile-scan .ark-assignment{margin:9px 0 5px!important}body.ark-mobile-scan .ark-shift-title,body.ark-mobile-scan .ark-assignment-title{font-size:14px!important;margin-bottom:6px!important}body.ark-mobile-scan .ark-shift-grid,body.ark-mobile-scan .ark-assignment-grid{gap:6px!important}body.ark-mobile-scan .ark-shift-opt span,body.ark-mobile-scan .ark-assignment-opt span{min-height:48px!important;font-size:13px!important;padding:7px 5px!important;border-radius:11px!important}body.ark-mobile-scan .ark-shift-help,body.ark-mobile-scan .ark-assignment-help{font-size:11px!important;margin-top:5px!important}body.ark-mobile-scan #pending{font-size:12px!important;margin-top:5px!important}
  ...
  @media(max-width:390px){#${TOP_STEPPER} .ark-m-step{font-size:10px;padding:6px 2px}body.ark-mobile-scan .ark-shift-opt span,body.ark-mobile-scan .ark-assignment-opt span{font-size:12px}body.ark-mobile-scan #app>h2{font-size:22px!important}}
...
function formReady(){const f=document.getElementById('f'),a=document.querySelector('input[name="arkShiftAction"]:checked'),assignment=document.querySelector('input[name="arkAssignmentClass"]:checked');try{return !!(f&&f.checkValidity()&&a&&assignment)}catch(_){return false}}
